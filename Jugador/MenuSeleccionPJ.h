...
class Menu{
    ...
    public:
        ...
        Jugador* seleccionarStrategy(){
            cout << "\n Seleecionar la estrategia que el jugador seguira: " << endl << endl;
        ...
        Jugador* menuSeleccion(){
            ...
            cout <<  endl <<"-- Digite uno de los siguientes numeros: --" << endl;
        ...
        Jugador* seleccionar3Mineros(){
            cout << endl <<"   MENU DE SELECCION DE PERSONAJE   " << endl;
            for (int i = 0; i < 3; i++)
            {
                cout << "   Minero: " << i+1 << " | " << i << " de " << "3" << endl;
                menuSeleccion();
            }
            return this->jugador;
